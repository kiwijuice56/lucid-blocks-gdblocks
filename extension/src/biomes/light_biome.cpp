...
DEFINE_CONSTRUCTORS_AND_BINDINGS(LightBiome);

void LightBiome::generate_chunk_data(Chunk* chunk, Vector3i chunk_position, Vector3i biome_coordinate) {
...
void LightBiome::generate_decorations(Vector3i chunk_position, Vector3i biome_coordinate) { }

int64_t LightBiome::get_ground_level(Vector3i position, Vector3i biome_coordinate) {
