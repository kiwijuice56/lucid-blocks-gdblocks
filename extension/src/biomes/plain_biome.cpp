...
void PlainBiome::_bind_methods() {
    BIND_PROPERTY(PlainBiome, bool, imprecise);
}

DEFINE_CONSTRUCTORS(PlainBiome);

DEFINE_PROPERTY_GETTER_SETTER(PlainBiome, bool, imprecise);

void PlainBiome::generate_chunk_data(Chunk* chunk, Vector3i chunk_position, Vector3i biome_coordinate) {
...
void PlainBiome::generate_decorations(Vector3i chunk_position, Vector3i biome_coordinate) {
